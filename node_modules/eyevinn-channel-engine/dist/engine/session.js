...
var Session = /** @class */ (function () {
    ...
    Session.prototype.stopPlayheadAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._sessionStateStore.isLeader(this._instanceId)];
                    case 1:
                        isLeader = _a.sent();
                        debug("[".concat(this._sessionId, "]: Stopping playhead consumer"));
                        return [4 /*yield*/, this._playheadState.set("state", PlayheadState.STOPPED, isLeader)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
                                ...
                                for (i = 0; i < audioGroupIds.length; i++) {
                                    ...
                                    for (j = 0; j < this._audioTracks.length; j++) {
                                        ...
                                        m3u8 += "#EXT-X-MEDIA:TYPE=AUDIO" +
                                            ...
                                            ",URI=\"index-".concat(audioGroupIdFileName, "_").concat(audioTrack.language, ".m3u8%3Bsession=").concat(this._sessionId, "\"") +
                                            "\n";
                                    }
                                }
    ...
    Session.prototype._truncateSlate = function (afterVod, requestedDuration, vodUri) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            try {
                ...
                var slateVod_2 = new HLSTruncateVod(nexVodUri, requestedDuration);
                var hlsVod_2;
                slateVod_2.load()
                    .then(function () {
                    var hlsOpts = {
