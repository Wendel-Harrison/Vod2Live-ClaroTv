...
var ChannelEngine = /** @class */ (function () {
        ...
        var handleMasterRoute = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        debug(req.params);
                        if (!req.params.file.match(/index.m3u8/)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._handleMasterManifest(req, res, next)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 2:
                        if (!(m = req.params.file.match(/index(\d+).m3u8/))) return [3 /*break*/, 4];
                        req.params[0] = m[1];
                        req.params[1] = m[2];
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 8];
                    case 4:
                        if (!(m = req.params.file.match(/index-(\S+)_(\S+).m3u8/))) return [3 /*break*/, 6];
                        req.params[0] = m[1];
                        req.params[1] = m[2];
                        req.params[2] = m[3];
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 8];
                    case 6:
                        if (!(m = req.params.file.match(/subtitles-(\S+)_(\S+).m3u8/))) return [3 /*break*/, 8];
                        req.params[0] = m[1];
                        req.params[1] = m[2];
                        req.params[2] = m[3];
    ...
    ChannelEngine.prototype.getMediaManifests = async function (channelId) {
        ...
        async function addM3U8(bw) {
            const indexManifest = await session.getCurrentMediaManifestAsync(bw.replace('master', 'index'));
            allMediaM3U8[bw] = indexManifest;
        }
    
        const promises = bandwidths.map(bw => addM3U8(bw));
